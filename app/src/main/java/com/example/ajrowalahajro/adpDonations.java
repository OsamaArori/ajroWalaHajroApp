...
public class adpDonations extends ArrayAdapter<String>
{
    ...
    public adpDonations(Context c,ArrayList<String> id, ArrayList<String> title, ArrayList<String> date , ArrayList<String> needpic,
               ArrayList<String> address, ArrayList<String> description ) {
        super(c, R.layout.listdonations, R.id.title, title);
        this.context = c;
        this.id=id;
        this.title = title;
        this.date = date;
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        View row = inf.inflate(R.layout.listdonations, parent, false);
